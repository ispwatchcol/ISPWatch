...
Detectado el 2026-09-22 al documentar el modo para el Centro de Ayuda (§ 73 de la bitácora).
...
> correcto es lo **ganado** (`earned − reversed`), y así está ya el comando (§ 74).
>
