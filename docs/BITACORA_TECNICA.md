...
**Última actualización:** 2026-08-05 (auditoría de Finanzas — Fases 1-6 completas: debounce e índices de listado, búsqueda en Gastos, paginación + agregados server-side, totales en dinero, exportación a CSV, unificación visual bajo el acento esmeralda e historial de Servicios Adicionales · **Servicios adicionales recurrentes — Fases 1-5/6: esquema, modelos, CRUD del catálogo, asignación por cliente, integración con el ciclo mensual y factura de excepción**) · Rama: `david-ux-ui-improve`
