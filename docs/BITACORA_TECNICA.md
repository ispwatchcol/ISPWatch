...
**Última actualización:** 2026-08-05 (auditoría de Finanzas — Fases 1-6 completas: debounce e índices de listado, búsqueda en Gastos, paginación + agregados server-side, totales en dinero, exportación a CSV, unificación visual bajo el acento esmeralda e historial de Servicios Adicionales · **Servicios adicionales recurrentes — Fases 1-6/6 COMPLETAS: esquema, modelos, CRUD del catálogo, asignación por cliente, integración con el ciclo mensual, factura de excepción y detector de servicios sin cobrar**) · Rama: `david-ux-ui-improve`
