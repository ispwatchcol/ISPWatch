...
**Última actualización:** 2026-08-05 (auditoría de Finanzas — Fases 1-5: debounce e índices de listado, búsqueda en Gastos, paginación + agregados server-side, totales en dinero, exportación a CSV y unificación visual de la sección bajo el acento esmeralda) · Rama: `david-ux-ui-improve`
