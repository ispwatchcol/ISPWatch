...
**Última actualización:** 2026-08-05 (auditoría de Finanzas — Fases 1-4: debounce e índices de listado, búsqueda en Gastos, paginación + agregados server-side, totales en dinero, exportación a CSV de los tres listados) · Rama: `david-ux-ui-improve`
