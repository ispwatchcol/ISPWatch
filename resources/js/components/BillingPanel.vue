            ...
            <button
              ...
              :class="[
                ...
                billing.notification_type === 'whatsapp'
                  ...
                  : 'border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:border-green-400 dark:hover:border-green-500'
              ]"
            >
              <div class="flex flex-col items-center gap-2">
            ...
            <button
              ...
              :class="[
                ...
                billing.notification_type === 'both'
                  ...
                  : 'border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:border-purple-400 dark:hover:border-purple-500'
              ]"
            >
              <div class="flex flex-col items-center gap-2">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
