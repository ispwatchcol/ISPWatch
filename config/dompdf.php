...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var bool
         */
        // Hardcoded false, not env()-driven: tenant-authored template content
        // (App\Services\Templates\TemplateRenderer) is rendered through this
        // same dompdf instance, so this must never depend on a default that
        // could silently change with a package upgrade.
        'enable_remote' => false,
